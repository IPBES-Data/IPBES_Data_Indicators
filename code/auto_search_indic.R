...
output_dir = 'G:/.shortcut-targets-by-id/18yX-16J7W2Kyq4Mn3YbU_HTjslZyr4hE/IPBES Task Force Knowledge and Data/_DATA/_TSU Internal/_ Weekly reports/Files - TSU Data/indicators/automated_search'
...
# 2- Manual inspection of paragraphs done in shared Google sheets by 3 people independently----
# https://drive.google.com/drive/u/0/folders/1VjeM5J6DKnDpq6q9CMmWeMHefyrfQyBN)
...
## Indicators from manual extraction in IPBES------
# Manual extraction of 'indicator', 'index', 'indicates', 'indices' from IPBES assessments

## Global Assessment

ga = read_sheet("https://docs.google.com/spreadsheets/d/1r5hlPo7NkjC3t5vp6T9hNepyRHExT5ulWC9s6QV7qcg/edit#gid=196528227",
...
indic_ga_ext = ga %>% 
  ...
  write_csv(paste0(gd_dir,'input_data2/automated_search/ga_extracted.csv'))

rm(ga)

## Sustainable Use

sua = read_sheet("https://docs.google.com/spreadsheets/d/12vw_y3x9cr_WZKI_ma-q7ckY4t53DwuKXaib6kaWzgg/edit#gid=220684707",
                 sheet = "sua_matches2") %>% 
...
indic_sua_ext = sua %>% 
  ...
  write_csv(paste0(gd_dir,'input_data2/automated_search/sua_extracted.csv'))

rm(sua) 

## values

va = read_sheet("https://docs.google.com/spreadsheets/d/1I8zbj5BwRVVhQ-aQ5V1lhSFJxBhajvbQNck_ERaTHE0/edit#gid=391596352",
...
indic_va_ext = va %>% 
  ...
  write_csv(paste0(gd_dir,'input_data2/automated_search/va_extracted.csv'))

rm(va)

## ias

ias = read_sheet("https://docs.google.com/spreadsheets/d/1ACXoJOjJvrX9iU9w34rY75RUMG28svZLXaTPvWbkRTM/edit#gid=1642803599",
                 sheet = "ias_matches") %>% 
  dplyr::select(indic_id,agree_val = `Agreement_validation (1,2,3)`,agree_indic = `Agreement_extracted`, ILK = ILK_indicators)
...
indic_ias_ext = ias %>% 
  ...
  write_csv(paste0(gd_dir,'input_data2/automated_search/ias_extracted.csv'))

rm(ias)

## Indicators from manual extraction in GEO------

geo = read_sheet("https://docs.google.com/spreadsheets/d/17so9rNta6gQlCBO1Q_XMiVbA6aSA3oYfyGeEli7Q_GQ/edit#gid=63849998",
                 sheet = "GEO6_matches") %>% 
  dplyr::select(indic_id,agree_val = `Agreement_validation (1,2,3)`,agree_indic = `Agreement_extracted`, ILK=ILK_indicators)
...
indic_geo_ext = geo %>% 
  ...
  write_csv(paste0(gd_dir,'input_data2/automated_search/geo_extracted.csv'))

rm(geo)
## Indicators from manual extraction in IPCC------

ipcc = read_sheet("https://docs.google.com/spreadsheets/d/1WWmImY2gjKmfwUir6mJLu254ttsv27wHLJNtirsCjnc/edit#gid=1177083939",
...
indic_ipcc_ext = ipcc %>% 
  ...
  write_csv(paste0(gd_dir,'input_data2/automated_search/ipcc_extracted.csv'))


### Append all extracted indicators----
